...
<!-- Default box -->
<div class="card mx-5 bg-white-2" style='box-shadow: none;'>
	<div class="card-body pb-0">
		...
		<div class="row mx-5">
			<div class="col-12 mx-5 pb-2 ">
				<div class="ml-0 pl-0 mt-4"><h3><?php echo $_GET['category_name']; ?></h3></div>
			</div>
                                ...
                                <?php
                                    ...
                                    <form method="post" id="bookmarkForm" action="includes/handlers/bookmark.php">
                                        ...
                                        if($user->isBookmark($row['id'])){?>
                                            <i onclick='submitBookmark(0, <?php echo $row["id"]; ?>)' class="fas fa-bookmark" style='color:blue;'></i>
                                        <?php
                                        }
                                        else{?>
                                            <i onclick='submitBookmark(1,  <?php echo $row["id"]; ?>)' class="far fa-bookmark"></i>
                                        <?php
                                        }
                                    ?>
		...
		<?php
			...
			?>
				...
				<div class="col-12 p-5 text-center m-4 border-top" style='height:50vh;'>
					...
					<i>No verified businesses in this category</i>
